---
title: "Synchrony_03.22.21_Continuous_Time"
output:
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_Pre_RelFunct <- brm(Dad ~ pnDAStot.2 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + pnDAStot.2*weeksbfdue.2 + pnDAStot.2*bage6pp + pnDAStot.2*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc|CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_Post_RelFunct <- brm(Dad ~ DAStotpp.2 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + DAStotpp.2*weeksbfdue.2 + DAStotpp.2*weeksbfdue.2 +DAStotpp.2*bage6pp + DAStotpp.2*Mom_cm +  DAStotpp.2*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_Pre_Cross_MarSat <- brm(Dad ~ pnMaritalSat.2 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + pnMaritalSat.2*weeksbfdue.2 + pnMaritalSat.2*bage6pp + pnMaritalSat.2*Mom_cm +  pnMaritalSat.2*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
interact_plot(Bayesian_Synchrony_Pre_Cross_MarSat, 
              pred = "Mom_cm",
              modx = "pnMaritalSat.2",
              modx.labels = "Prenatal Mother Marital Satisfaction", 
              plot.points = TRUE, 
              point.size = 0.5, 
              point.alpha = 0.2, 
              facet.modx = TRUE,  # use this to make two panels
              x.label = "Mothers' Average Testosterone", 
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_Parenting <- brm(Dad ~ PARYCtot.2 + weeksbfdue.2 + bage6pp  + Mom_cm + Mom_cmc + PARYCtot.2*weeksbfdue.2 + PARYCtot.2*bage6pp + PARYCtot.2*Mom_cm + PARYCtot.2 *Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
Bayesian_Synchrony_Bonding <- brm(Dad ~ PBQ.2 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + PBQ.2*weeksbfdue.2 + PBQ.2*bage6pp + PBQ.2*Mom_cm + PBQ.2*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_attachment <- brm(Dad ~ PPNAS_tot.2 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + PPNAS_tot.2*weeksbfdue.2 + PPNAS_tot.2*bage6pp + PPNAS_tot.2*Mom_cm + PPNAS_tot.2*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_RelFunct_Mom_Pre <- brm(Dad ~ pnDAStot.1 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + pnDAStot.1*weeksbfdue.2 + pnDAStot.1*bage6pp + pnDAStot.1*Mom_cm +  pnDAStot.1*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r,, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_RelFunct_Mom_Post <- brm(Dad ~ DAStotpp.1 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + DAStotpp.1*weeksbfdue.2 + DAStotpp.1*bage6pp + DAStotpp.1*Mom_cm +  DAStotpp.1*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_MarSat_Mom_Post <- brm(Dad ~ MAT1pp + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + MAT1pp*weeksbfdue.2 + MAT1pp*bage6pp + MAT1pp*Time + MAT1pp*Mom_cm +  MAT1pp*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_Parenting_Mom <- brm(Dad ~ PARYCtot.1 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + PARYCtot.1*weeksbfdue.2 + PARYCtot.1*bage6pp + PARYCtot.1*Mom_cm + PARYCtot.1 *Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_Bonding_Mom <- brm(Dad ~ PBQ.1 + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + PBQ.1*weeksbfdue.2 + PBQ.1*bage6pp + PBQ.1*Mom_cm + PBQ.1*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
...
```{r, warning = FALSE, message=FALSE, echo=FALSE, results='hide'}
Bayesian_Synchrony_attachment_Mom <- brm(Dad ~ MPNAS_tot + weeksbfdue.2 + bage6pp + Mom_cm + Mom_cmc + MPNAS_tot*weeksbfdue.2 + MPNAS_tot*bage6pp + MPNAS_tot*Mom_cm + MPNAS_tot*Mom_cmc + Mom_cmc*weeksbfdue.2 + Mom_cmc*bage6pp + (Mom_cmc | CoupID),
               seed = 2155,
               control = list(max_treedepth = 15, adapt_delta = .995),
               chains = 8, 
               iter = 4000, data = df_LONG)
