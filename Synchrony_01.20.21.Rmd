...
Testosterone_Prenatal_Mother <- stat.desc(finaldt_4$Mompn1)
Testosterone_Prenatal_Mother
```

```{r Testosterone_Prenatal_Father}
Testosterone_Prenatal_Father <- stat.desc(finaldt_4$Dadpn1)
Testosterone_Prenatal_Father
```

```{r Testosterone_Postpartuml_Mother}
Testosterone_Postpartuml_Mother <- stat.desc(finaldt_4$Mompp1)
Testosterone_Postpartuml_Mother
```

```{r Testosterone_Postpartuml_Father}
Testosterone_Postpartuml_Father <- stat.desc(finaldt_4$Dadpp1)
...
Corr_var <- finaldt_4 %>% 
  select(pnAge_1.1, pnAge_1.2, monthspreg.1, bage6pp, Mompn1, Dadpn1, Mompp1, Dadpp1, Dad_Change, DAStotpp.1, DAStotpp.2, MAT1pp, MAT2pp, PARYCtot.1, PARYCtot.2, PBQ.1, PBQ.2)
